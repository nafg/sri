...
object DefaultAndroidNavigationBar {
  ...
  def apply(route: NavigatorRoute, style: Style = DefaultTheme, key: js.UndefOr[String] = js.undefined, ref: js.Function1[Component, Unit] = null) =
    makeElement[Component](props = Props(route, style), key = key, ref = ref)
